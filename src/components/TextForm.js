...
<button className='btn btn-success mx-2 my-2' onClick={handleUpperCaseClick}>Convert to UpperCase</button>
<button className='btn btn-success mx-2 my-2' onClick={handleLowerCaseClick}>Convert to LowerCase</button>
